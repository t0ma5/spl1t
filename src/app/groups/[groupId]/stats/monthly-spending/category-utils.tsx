...
export type MonthlyCategorySpending = NonNullable<
  NonNullable<
    AppRouterOutput['groups']['stats']['get']
  >['monthlyCategorySpending']
>
export type MonthlySpendingCategory =
  MonthlyCategorySpending['categories'][number]
export type MonthlySpendingMonth = MonthlyCategorySpending['months'][number]
