 ...
 * hold differently shaped `paidFor` rows, so they map into this shape rather
 ...
 * stored shares do not satisfy the schema invariants still split the full
 * amount and nothing leaks. Reimbursements are not special-cased here —
